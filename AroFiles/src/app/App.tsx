          ...
          >
            <div className="relative flex flex-col items-center justify-center min-h-[calc(100vh-73px)] text-center py-16">
              ...
              <motion.h1
                ...
                className="text-6xl lg:text-8xl font-extrabold leading-tight mb-4 text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 via-yellow-400 to-amber-600"
              ...
              <motion.p
                ...
                className="text-xl lg:text-2xl font-semibold text-white/60 mb-6 tracking-widest uppercase"
              >
                {t.heroSubtitle}
              </motion.p>
