...
import { X, CheckCircle, Clock, RefreshCw, Package, Truck, Lock, Plus, Trash2, Edit2, BarChart2, Search, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="space-y-3 p-4 bg-white/5 border border-yellow-500/20 rounded-xl">
      ...
      <div>
        <label className="text-white/40 text-xs mb-1 block">
          Image URL — paste any public image link (e.g. from Unsplash, imgur, etc.)
        </label>
        ...
        {data.image && (
          <img src={data.image} alt="preview" className="mt-2 h-24 rounded-lg object-cover border border-yellow-500/20"
      ...
      <div className="flex gap-2 pt-1">
        ...
        <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.97 }}
          onClick={() => onSave(data)} disabled={savingProduct}
