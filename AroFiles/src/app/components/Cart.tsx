...
const CRYPTO_WALLETS = [
  { id: 'usdt_bep20', name: 'USDT (BEP20)', symbol: 'USDT', address: '0x8c99c1ab0e9a6a99b0b2815fa4832d8e3d2af58f', color: 'bg-green-500' },
  { id: 'usdt_erc20', name: 'USDT (ERC20)', symbol: 'USDT', address: '0x8c99c1ab0e9a6a99b0b2815fa4832d8e3d2af58f', color: 'bg-blue-500' },
  { id: 'usdt_trc20', name: 'USDT (TRC20)', symbol: 'USDT', address: 'TMmDbHQyYgE71uwavadabUnJ23fqWVeZYq', color: 'bg-red-500' },
  { id: 'btc', name: 'Bitcoin (BTC)', symbol: 'BTC', address: '13t5uBgUKPVvo6n5RvVjN1bJshCjgeVUi1', color: 'bg-orange-500' },
  { id: 'ltc', name: 'Litecoin (LTC)', symbol: 'LTC', address: 'LSofNzGtMiTqHgKu7RPKQHTtX2BQvjndad', color: 'bg-gray-400' },
  { id: 'eth_erc20', name: 'Ethereum (ETH)', symbol: 'ETH', address: '0x8c99c1ab0e9a6a99b0b2815fa4832d8e3d2af58f', color: 'bg-purple-500' },
];
                      ...
                      <>
                        ...
                        >
                          ...
                          <div className="text-left">
                            ...
                            <p className="text-white/40 text-xs">Send to: {PAYMENT_NUMBERS['bkash']}</p>
                          </div>
                        ...
                        <div className="relative">
                          <motion.button
                            key="nagad"
                            className="w-full bg-white/5 border border-yellow-500/20 rounded-xl p-5 flex items-center gap-4 opacity-50 cursor-not-allowed"
                          >
                          ...
                          <div className="absolute top-2 right-2 bg-yellow-500 text-black text-xs font-black px-2 py-0.5 rounded-full">COMING SOON</div>
                        </div>
                      </>
                    )}
                  </motion.div>
