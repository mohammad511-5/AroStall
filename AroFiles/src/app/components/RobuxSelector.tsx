...
export function RobuxSelector({ onAddToCart }: RobuxSelectorProps) {
  ...
  const price = currency === 'USD'
    ? Math.round((robuxAmount / 1000) * 6.89 * 100) / 100
    : Math.round((robuxAmount / 1000) * 850);
  ...
  const addToCart = () => {
    const bdtPrice = Math.round((robuxAmount / 1000) * 850);
    const usdPrice = Math.round((robuxAmount / 1000) * 6.89 * 100) / 100;
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/5 rounded-xl p-6 border border-yellow-500/20">
              ...
              <div className="bg-yellow-500/10 rounded-lg px-4 py-2 border border-yellow-500/30">
                <p className="text-yellow-300 text-sm text-center">{currency === 'USD' ? 'Rate: $6.89 per 1,000 Robux' : 'Rate: ৳850 per 1,000 Robux'}</p>
              </div>
            </div>
