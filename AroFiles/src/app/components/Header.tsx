        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center bg-white/5 border border-white/10 rounded-lg overflow-hidden text-sm font-semibold">
            <motion.button
              ...
              className={`px-3 py-1.5 transition-colors ${currency === 'BDT' ? 'bg-yellow-500 text-black' : 'text-white/50 hover:text-white'}`}
            >
              ৳
            </motion.button>
            ...
            <motion.button
              ...
              className={`px-3 py-1.5 transition-colors ${currency === 'USD' ? 'bg-yellow-500 text-black' : 'text-white/50 hover:text-white'}`}
            >
              $
            </motion.button>
          </div>
