...
export const translations = {
  en: {
    ...
    trustedBadge: '🏆 Trusted Roblox Marketplace',
    heroTitle1: 'AroStall',
    heroTitle2: '',
    heroSubtitle: 'Reliable Roblox Marketplace',
    heroDesc: 'Discover a secure marketplace for Robux, Limiteds, and Game Bundles. Join hundreds of satisfied customers enjoying reliable service and unbeatable deals.',
  ...
  bn: {
    ...
    trustedBadge: '🏆 বিশ্বস্ত রোবলক্স মার্কেটপ্লেস',
    heroTitle1: 'AroStall',
    heroTitle2: '',
    heroSubtitle: 'নির্ভরযোগ্য রোবলক্স মার্কেটপ্লেস',
    heroDesc: 'রোবাক্স, লিমিটেড এবং গেম বান্ডেলের জন্য একটি নিরাপদ মার্কেটপ্লেস আবিষ্কার করুন। শত শত সন্তুষ্ট গ্রাহকের সাথে যোগ দিন।',
